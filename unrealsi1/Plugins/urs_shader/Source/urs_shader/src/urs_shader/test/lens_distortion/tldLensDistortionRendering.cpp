...
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationVS, TEXT("/urs_shader/test/lens_distortion/tldTestLensDistortionShader.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationPS, TEXT("/urs_shader/test/lens_distortion/tldTestLensDistortionShader.usf"), TEXT("MainPS"), SF_Pixel)
