...
USTRUCT()
struct URS_RENDER_API FursSimpleParticleConfigs
{
	GENERATED_BODY()
public:
...
public:
	...
	UPROPERTY(EditAnywhere)	FLinearColor			color	= FLinearColor::White;
...
public:
	...
	bool	isValid()			const { return getThreadGroup() > 0 && texture; }
};
