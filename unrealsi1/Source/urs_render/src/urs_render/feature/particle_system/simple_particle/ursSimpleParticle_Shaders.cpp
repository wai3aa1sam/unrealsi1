...
IMPLEMENT_GLOBAL_SHADER(FursSimpleParticle_CS, "/urs_render/feature/particle_system/simple_particle/ursSimpleParticle_CS.usf",				"CS_main", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FursSimpleParticle_VS, "/urs_render/feature/particle_system/simple_particle/ursSimpleParticle_GraphicsShader.usf",	"VS_main", SF_Vertex);
IMPLEMENT_GLOBAL_SHADER(FursSimpleParticle_PS, "/urs_render/feature/particle_system/simple_particle/ursSimpleParticle_GraphicsShader.usf",	"PS_main", SF_Pixel);
