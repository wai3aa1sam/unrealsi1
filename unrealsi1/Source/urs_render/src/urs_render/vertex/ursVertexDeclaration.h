...
struct URS_RENDER_API FursVertex_PosColor
{
public:
	FVector4f position;
	FVector2f uv;
...
class URS_RENDER_API FursVertexDeclaration_PosColor : public FRenderResource
{
public:
...
URS_RENDER_API extern TGlobalResource<FursVertexDeclaration_PosColor> urs_g_vertexDecl_PosColor;
